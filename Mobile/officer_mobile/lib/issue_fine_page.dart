...
class _IssueFinePageState extends State<IssueFinePage> {
  ...
  Future<void> _createNotification(int userId, String title, String body) async {
    final notificationUrl = 'http://192.168.130.85:5000/notifications/notifications/create';
  ...
  Future<void> _issueFine() async {
    ...
    final apiUrl = 'http://192.168.130.85:5000/api/auth/officer/issue-fine';
    final fineData = {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await _createNotification(
          widget.driverId,
          'Fine Issued',
          'A fine has been issued successfully for the selected violation.',
        );
